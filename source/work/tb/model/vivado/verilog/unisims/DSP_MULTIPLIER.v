...
// inputs with no timing checks
  assign #(in_delay) A2A1_dly = A2A1;
  assign #(in_delay) AD_DATA_dly = AD_DATA;
  assign #(in_delay) B2B1_dly = B2B1;


  assign A2A1_in = A2A1_dly;
  assign AD_DATA_in = AD_DATA_dly;
  assign B2B1_in = B2B1_dly;
  assign A2A1_in = A2A1;
