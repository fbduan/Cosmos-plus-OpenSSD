...
// inputs with no timing checks
  assign #(in_delay) ADDSUB_dly = ADDSUB;
  assign #(in_delay) D_DATA_dly = D_DATA;
  assign #(in_delay) INMODE2_dly = INMODE2;
  assign #(in_delay) PREADD_AB_dly = PREADD_AB;


  assign ADDSUB_in = ADDSUB_dly;
  assign D_DATA_in = D_DATA_dly;
  assign INMODE2_in = INMODE2_dly;
  assign PREADD_AB_in = PREADD_AB_dly;
