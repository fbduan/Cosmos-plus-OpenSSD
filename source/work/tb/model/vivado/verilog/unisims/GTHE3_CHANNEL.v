...
// inputs with no timing checks
  ...
  #1;
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-554] SIM_VERSION attribute is set to %d.  Legal values for this attribute are 2, 1 or 3. Instance: %m", MODULE_NAME, SIM_VERSION_REG);
      attr_err = 1'b1;
    end
   ...
   ((TX_PROGDIV_CFG_REG != 0.0) &&
    ...
    $display("Error: [Unisim %s-626] TX_PROGDIV_CFG attribute is set to %f.  Legal values for this attribute are 0.0, 4.0, 5.0, 8.0, 10.0, 16.0, 16.5, 20.0, 32.0, 33.0, 40.0, 64.0, 66.0, 80.0 or 100.0. Instance: %m", MODULE_NAME, TX_PROGDIV_CFG_REG);
    attr_err = 1'b1;
    end
