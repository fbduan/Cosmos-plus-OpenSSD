...
`endif
  ...
  #1;
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-103] RAM_ADDRESS_MASK attribute is set to %b.  Legal values for this attribute are 3'b000 to 3'b111. Instance: %m", MODULE_NAME, RAM_ADDRESS_MASK);
      attr_err = 1'b1;
    end

    if ((attr_test == 1'b1) ||
        ((RAM_ADDRESS_SPACE < 3'b000) || (RAM_ADDRESS_SPACE > 3'b111))) begin
      $display("Error: [Unisim %s-104] RAM_ADDRESS_SPACE attribute is set to %b.  Legal values for this attribute are 3'b000 to 3'b111. Instance: %m", MODULE_NAME, RAM_ADDRESS_SPACE);
      attr_err = 1'b1;
    end
