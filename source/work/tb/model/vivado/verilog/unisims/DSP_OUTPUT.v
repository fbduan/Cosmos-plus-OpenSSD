...
`ifdef XIL_TIMING
  wire CARRYCASCOUT_dly;
  wire CCOUT_FB_dly;
  wire MULTSIGNOUT_dly;
  wire OVERFLOW_dly;
  wire PATTERN_B_DETECT_dly;
  wire PATTERN_DETECT_dly;
  wire P_FDBK_47_dly;
  wire UNDERFLOW_dly;
  wire [3:0] CARRYOUT_dly;
  wire [47:0] PCOUT_dly;
...
`ifdef XIL_TIMING
  assign ALUMODE10_in = ALUMODE10_dly;
  assign #1 ALU_OUT_in = ALU_OUT_dly; // break 0 delay feedback
  assign CEP_in = (CEP !== 1'bz) && CEP_dly; // rv 0
  assign CLK_preg   = ((CLK !== 1'bz) && (PREG_BIN != PREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign COUT_in = COUT_dly;
  assign C_DATA_in = C_DATA_dly;
  assign MULTSIGN_ALU_in = MULTSIGN_ALU_dly;
  assign RSTP_in = (RSTP !== 1'bz) && (RSTP_dly ^ IS_RSTP_INVERTED_BIN); // rv 0
  assign XOR_MX_in = XOR_MX_dly;
`else
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge CLK, negedge ALUMODE10, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALUMODE10_dly);
    $setuphold (negedge CLK, negedge ALU_OUT, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALU_OUT_dly);
    $setuphold (negedge CLK, negedge CEP, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEP_dly);
    $setuphold (negedge CLK, negedge COUT, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, COUT_dly);
    $setuphold (negedge CLK, negedge C_DATA, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, C_DATA_dly);
    $setuphold (negedge CLK, negedge MULTSIGN_ALU, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, MULTSIGN_ALU_dly);
    $setuphold (negedge CLK, negedge RSTP, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTP_dly);
    $setuphold (negedge CLK, negedge XOR_MX, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, XOR_MX_dly);
    $setuphold (negedge CLK, posedge ALUMODE10, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALUMODE10_dly);
    $setuphold (negedge CLK, posedge ALU_OUT, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALU_OUT_dly);
    $setuphold (negedge CLK, posedge CEP, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEP_dly);
    $setuphold (negedge CLK, posedge COUT, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, COUT_dly);
    $setuphold (negedge CLK, posedge C_DATA, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, C_DATA_dly);
    $setuphold (negedge CLK, posedge MULTSIGN_ALU, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, MULTSIGN_ALU_dly);
    $setuphold (negedge CLK, posedge RSTP, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTP_dly);
    $setuphold (negedge CLK, posedge XOR_MX, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, XOR_MX_dly);
    $setuphold (posedge CLK, negedge ALUMODE10, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALUMODE10_dly);
    $setuphold (posedge CLK, negedge ALU_OUT, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALU_OUT_dly);
    $setuphold (posedge CLK, negedge CEP, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEP_dly);
    $setuphold (posedge CLK, negedge COUT, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, COUT_dly);
    $setuphold (posedge CLK, negedge C_DATA, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, C_DATA_dly);
    $setuphold (posedge CLK, negedge MULTSIGN_ALU, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, MULTSIGN_ALU_dly);
    $setuphold (posedge CLK, negedge RSTP, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTP_dly);
    $setuphold (posedge CLK, negedge XOR_MX, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, XOR_MX_dly);
    $setuphold (posedge CLK, posedge ALUMODE10, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALUMODE10_dly);
    $setuphold (posedge CLK, posedge ALU_OUT, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALU_OUT_dly);
    $setuphold (posedge CLK, posedge CEP, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEP_dly);
    $setuphold (posedge CLK, posedge COUT, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, COUT_dly);
    $setuphold (posedge CLK, posedge C_DATA, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, C_DATA_dly);
    $setuphold (posedge CLK, posedge MULTSIGN_ALU, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, MULTSIGN_ALU_dly);
    $setuphold (posedge CLK, posedge RSTP, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTP_dly);
    $setuphold (posedge CLK, posedge XOR_MX, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, XOR_MX_dly);
