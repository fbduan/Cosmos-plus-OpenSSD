...
`ifdef XIL_TIMING
    ...
    $recrem ( negedge RX_CE, negedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_n, rx_clk_en_n, RX_CE_delay, RX_CLK_delay);
    $recrem ( negedge RX_CE, posedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_p, rx_clk_en_p, RX_CE_delay, RX_CLK_delay);
    $recrem ( negedge RX_LOAD, negedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_n, rx_clk_en_n, RX_LOAD_delay, RX_CLK_delay);
    $recrem ( negedge RX_LOAD, posedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_p, rx_clk_en_p, RX_LOAD_delay, RX_CLK_delay);
    $recrem ( negedge TX_CE, negedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_n, tx_clk_en_n, TX_CE_delay, TX_CLK_delay);
    $recrem ( negedge TX_CE, posedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_p, tx_clk_en_p, TX_CE_delay, TX_CLK_delay);
    $recrem ( negedge TX_LOAD, negedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_n, tx_clk_en_n, TX_LOAD_delay, TX_CLK_delay);
    $recrem ( negedge TX_LOAD, posedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_p, tx_clk_en_p, TX_LOAD_delay, TX_CLK_delay);
    $recrem ( posedge RX_CE, negedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_n, rx_clk_en_n, RX_CE_delay, RX_CLK_delay);
    $recrem ( posedge RX_CE, posedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_p, rx_clk_en_p, RX_CE_delay, RX_CLK_delay);
    $recrem ( posedge RX_LOAD, negedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_n, rx_clk_en_n, RX_LOAD_delay, RX_CLK_delay);
    $recrem ( posedge RX_LOAD, posedge RX_CLK, 0:0:0, 0:0:0, notifier, rx_clk_en_p, rx_clk_en_p, RX_LOAD_delay, RX_CLK_delay);
    $recrem ( posedge TX_CE, negedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_n, tx_clk_en_n, TX_CE_delay, TX_CLK_delay);
    $recrem ( posedge TX_CE, posedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_p, tx_clk_en_p, TX_CE_delay, TX_CLK_delay);
    $recrem ( posedge TX_LOAD, negedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_n, tx_clk_en_n, TX_LOAD_delay, TX_CLK_delay);
    $recrem ( posedge TX_LOAD, posedge TX_CLK, 0:0:0, 0:0:0, notifier, tx_clk_en_p, tx_clk_en_p, TX_LOAD_delay, TX_CLK_delay);
