...
`ifdef XIL_TIMING
  ...
  wire [17:0] B2B1_dly;
  wire [26:0] A2A1_dly;
  wire [26:0] AD_DATA_dly;
  wire [26:0] D_DATA_dly;
  wire [26:0] PREADD_AB_dly;
...
`ifdef XIL_TIMING
  assign #(in_delay) A1_DATA_dly = A1_DATA;
  assign #(in_delay) A2_DATA_dly = A2_DATA;
  assign #(in_delay) B1_DATA_dly = B1_DATA;
  assign #(in_delay) B2_DATA_dly = B2_DATA;
`endif


`ifdef XIL_TIMING
  assign A1_DATA_in = A1_DATA_dly;
  assign A2_DATA_in = A2_DATA_dly;
  assign AD_in = AD_dly;
  assign B1_DATA_in = B1_DATA_dly;
  assign B2_DATA_in = B2_DATA_dly;
  assign CEAD_in = (CEAD !== 1'bz) && CEAD_dly; // rv 0
  assign CED_in = (CED !== 1'bz) && CED_dly; // rv 0
  assign CEINMODE_in = CEINMODE_dly;
  assign CLK_inmode = ((CLK !== 1'bz) && (INMODEREG_BIN != INMODEREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign CLK_dreg   = ((CLK !== 1'bz) && (DREG_BIN != DREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign CLK_adreg  = ((CLK !== 1'bz) && (ADREG_BIN != ADREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign DIN_in[0] = (DIN[0] !== 1'bz) && DIN_dly[0]; // rv 0
  assign DIN_in[10] = (DIN[10] !== 1'bz) && DIN_dly[10]; // rv 0
  assign DIN_in[11] = (DIN[11] !== 1'bz) && DIN_dly[11]; // rv 0
  assign DIN_in[12] = (DIN[12] !== 1'bz) && DIN_dly[12]; // rv 0
  assign DIN_in[13] = (DIN[13] !== 1'bz) && DIN_dly[13]; // rv 0
  assign DIN_in[14] = (DIN[14] !== 1'bz) && DIN_dly[14]; // rv 0
  assign DIN_in[15] = (DIN[15] !== 1'bz) && DIN_dly[15]; // rv 0
  assign DIN_in[16] = (DIN[16] !== 1'bz) && DIN_dly[16]; // rv 0
  assign DIN_in[17] = (DIN[17] !== 1'bz) && DIN_dly[17]; // rv 0
  assign DIN_in[18] = (DIN[18] !== 1'bz) && DIN_dly[18]; // rv 0
  assign DIN_in[19] = (DIN[19] !== 1'bz) && DIN_dly[19]; // rv 0
  assign DIN_in[1] = (DIN[1] !== 1'bz) && DIN_dly[1]; // rv 0
  assign DIN_in[20] = (DIN[20] !== 1'bz) && DIN_dly[20]; // rv 0
  assign DIN_in[21] = (DIN[21] !== 1'bz) && DIN_dly[21]; // rv 0
  assign DIN_in[22] = (DIN[22] !== 1'bz) && DIN_dly[22]; // rv 0
  assign DIN_in[23] = (DIN[23] !== 1'bz) && DIN_dly[23]; // rv 0
  assign DIN_in[24] = (DIN[24] !== 1'bz) && DIN_dly[24]; // rv 0
  assign DIN_in[25] = (DIN[25] !== 1'bz) && DIN_dly[25]; // rv 0
  assign DIN_in[26] = (DIN[26] !== 1'bz) && DIN_dly[26]; // rv 0
  assign DIN_in[2] = (DIN[2] !== 1'bz) && DIN_dly[2]; // rv 0
  assign DIN_in[3] = (DIN[3] !== 1'bz) && DIN_dly[3]; // rv 0
  assign DIN_in[4] = (DIN[4] !== 1'bz) && DIN_dly[4]; // rv 0
  assign DIN_in[5] = (DIN[5] !== 1'bz) && DIN_dly[5]; // rv 0
  assign DIN_in[6] = (DIN[6] !== 1'bz) && DIN_dly[6]; // rv 0
  assign DIN_in[7] = (DIN[7] !== 1'bz) && DIN_dly[7]; // rv 0
  assign DIN_in[8] = (DIN[8] !== 1'bz) && DIN_dly[8]; // rv 0
  assign DIN_in[9] = (DIN[9] !== 1'bz) && DIN_dly[9]; // rv 0
  assign INMODE_in[0] = (INMODE[0] !== 1'bz) && (INMODE_dly[0] ^ IS_INMODE_INVERTED_BIN[0]); // rv 0
  assign INMODE_in[1] = (INMODE[1] !== 1'bz) && (INMODE_dly[1] ^ IS_INMODE_INVERTED_BIN[1]); // rv 0
  assign INMODE_in[2] = (INMODE[2] !== 1'bz) && (INMODE_dly[2] ^ IS_INMODE_INVERTED_BIN[2]); // rv 0
  assign INMODE_in[3] = (INMODE[3] !== 1'bz) && (INMODE_dly[3] ^ IS_INMODE_INVERTED_BIN[3]); // rv 0
  assign INMODE_in[4] = (INMODE[4] !== 1'bz) && (INMODE_dly[4] ^ IS_INMODE_INVERTED_BIN[4]); // rv 0
  assign RSTD_in = (RSTD !== 1'bz) && (RSTD_dly ^ IS_RSTD_INVERTED_BIN); // rv 0
  assign RSTINMODE_in = (RSTINMODE !== 1'bz) && (RSTINMODE_dly ^ IS_RSTINMODE_INVERTED_BIN); // rv 0
`else
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge CLK, negedge AD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, AD_dly);
    $setuphold (negedge CLK, negedge CEAD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEAD_dly);
    $setuphold (negedge CLK, negedge CED, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CED_dly);
    $setuphold (negedge CLK, negedge CEINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEINMODE_dly);
    $setuphold (negedge CLK, negedge DIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, DIN_dly);
    $setuphold (negedge CLK, negedge INMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, INMODE_dly);
    $setuphold (negedge CLK, negedge RSTD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTD_dly);
    $setuphold (negedge CLK, negedge RSTINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTINMODE_dly);
    $setuphold (negedge CLK, posedge AD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, AD_dly);
    $setuphold (negedge CLK, posedge CEAD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEAD_dly);
    $setuphold (negedge CLK, posedge CED, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CED_dly);
    $setuphold (negedge CLK, posedge CEINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEINMODE_dly);
    $setuphold (negedge CLK, posedge DIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, DIN_dly);
    $setuphold (negedge CLK, posedge INMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, INMODE_dly);
    $setuphold (negedge CLK, posedge RSTD, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTD_dly);
    $setuphold (negedge CLK, posedge RSTINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTINMODE_dly);
    $setuphold (posedge CLK, negedge AD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, AD_dly);
    $setuphold (posedge CLK, negedge CEAD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEAD_dly);
    $setuphold (posedge CLK, negedge CED, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CED_dly);
    $setuphold (posedge CLK, negedge CEINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEINMODE_dly);
    $setuphold (posedge CLK, negedge DIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, DIN_dly);
    $setuphold (posedge CLK, negedge INMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, INMODE_dly);
    $setuphold (posedge CLK, negedge RSTD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTD_dly);
    $setuphold (posedge CLK, negedge RSTINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTINMODE_dly);
    $setuphold (posedge CLK, posedge AD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, AD_dly);
    $setuphold (posedge CLK, posedge CEAD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEAD_dly);
    $setuphold (posedge CLK, posedge CED, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CED_dly);
    $setuphold (posedge CLK, posedge CEINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEINMODE_dly);
    $setuphold (posedge CLK, posedge DIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, DIN_dly);
    $setuphold (posedge CLK, posedge INMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, INMODE_dly);
    $setuphold (posedge CLK, posedge RSTD, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTD_dly);
    $setuphold (posedge CLK, posedge RSTINMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTINMODE_dly);
