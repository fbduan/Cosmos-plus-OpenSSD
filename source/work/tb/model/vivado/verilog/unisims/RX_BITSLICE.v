...
`ifdef XIL_TIMING
    ...
    $recrem ( negedge CE, negedge CLK, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, CE_delay, CLK_delay);
    $recrem ( negedge CE, posedge CLK, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, CE_delay, CLK_delay);
    $recrem ( negedge CE_EXT, negedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_n, clk_ext_en_n, CE_EXT_delay, CLK_EXT_delay);
    $recrem ( negedge CE_EXT, posedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_p, clk_ext_en_p, CE_EXT_delay, CLK_EXT_delay);
    $recrem ( negedge LOAD, negedge CLK, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, LOAD_delay, CLK_delay);
    $recrem ( negedge LOAD, posedge CLK, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, LOAD_delay, CLK_delay);
    $recrem ( negedge LOAD_EXT, negedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_n, clk_ext_en_n, LOAD_EXT_delay, CLK_EXT_delay);
    $recrem ( negedge LOAD_EXT, posedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_p, clk_ext_en_p, LOAD_EXT_delay, CLK_EXT_delay);
    $recrem ( posedge CE, negedge CLK, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, CE_delay, CLK_delay);
    $recrem ( posedge CE, posedge CLK, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, CE_delay, CLK_delay);
    $recrem ( posedge CE_EXT, negedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_n, clk_ext_en_n, CE_EXT_delay, CLK_EXT_delay);
    $recrem ( posedge CE_EXT, posedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_p, clk_ext_en_p, CE_EXT_delay, CLK_EXT_delay);
    $recrem ( posedge LOAD, negedge CLK, 0:0:0, 0:0:0, notifier, clk_en_n, clk_en_n, LOAD_delay, CLK_delay);
    $recrem ( posedge LOAD, posedge CLK, 0:0:0, 0:0:0, notifier, clk_en_p, clk_en_p, LOAD_delay, CLK_delay);
    $recrem ( posedge LOAD_EXT, negedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_n, clk_ext_en_n, LOAD_EXT_delay, CLK_EXT_delay);
    $recrem ( posedge LOAD_EXT, posedge CLK_EXT, 0:0:0, 0:0:0, notifier, clk_ext_en_p, clk_ext_en_p, LOAD_EXT_delay, CLK_EXT_delay);
