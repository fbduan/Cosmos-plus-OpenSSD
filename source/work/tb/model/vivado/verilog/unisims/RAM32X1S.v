...
`endif
  ...
  #1;
    if ((attr_test == 1'b1) ||
        ((INIT < 32'h00000000) || (INIT > 32'hFFFFFFFF))) begin
      $display("Error: [Unisim %s-101] INIT attribute is set to %h.  Legal values for this attribute are 32'h00000000 to 32'hFFFFFFFF. Instance: %m", MODULE_NAME, INIT);
      attr_err = 1'b1;
    end
