...
`endif
  ...
  #1;
    if ((attr_test == 1'b1) ||
        ((INIT < 128'h00000000000000000000000000000000) || (INIT > 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF))) begin
      $display("Error: [Unisim %s-101] INIT attribute is set to %h.  Legal values for this attribute are 128'h00000000000000000000000000000000 to 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF. Instance: %m", MODULE_NAME, INIT);
      attr_err = 1'b1;
    end
