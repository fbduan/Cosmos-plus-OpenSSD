...
// define constants
  ...
  localparam ODATAIN_INTRINSIC_DELAY = 60;
...
// inputs with no timing checks
  ...
  #1;
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-110] UPDATE_MODE attribute is set to %s.  Legal values for this attribute are ASYNC, MANUAL or SYNC. Instance: %m", MODULE_NAME, UPDATE_MODE_REG);
      attr_err = 1'b1;
    end
