...
`endif // XIL_TIMING
    ...
    wire injectdbiterr_inv, injectsbiterr_inv;
    wire [63:0] di_inv;
    wire [7:0] dip_inv;
    wire regce_inv;
...
`ifdef XIL_TIMING
    ...
    assign injectdbiterr_inv = INJECTDBITERR_dly;
    assign injectsbiterr_inv = INJECTSBITERR_dly;
...
`ifndef XIL_TIMING
    ...
    assign injectdbiterr_inv = INJECTDBITERR;   // XIL_TIMING
    assign injectsbiterr_inv = INJECTSBITERR;   // XIL_TIMING
...
`endif //  `ifndef XIL_TIMING
    ...
    assign di_in = di_inv ^ 64'h0000000000000000;
    assign dip_in = dip_inv ^ 8'h00;
    assign injectdbiterr_in = injectdbiterr_inv ^ 1'b0;
    assign injectsbiterr_in = injectsbiterr_inv ^ 1'b0;
...
`ifdef XIL_TIMING
   ...
   wire wrclk_en_n;
   wire wrclk_en_p;
   assign rdclk_en_n =  IS_RDCLK_INVERTED;
   assign rdclk_en_p = ~IS_RDCLK_INVERTED;
   assign wrclk_en_n =  IS_WRCLK_INVERTED;
   assign wrclk_en_p = ~IS_WRCLK_INVERTED;
