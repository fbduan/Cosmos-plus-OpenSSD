...
`ifdef XIL_TIMING
  wire ALUMODE10_dly;
  wire MULTSIGN_ALU_dly;
  wire [3:0] COUT_dly;
  wire [47:0] ALU_OUT_dly;
  wire [7:0] XOR_MX_dly;
...
`ifdef XIL_TIMING
  ...
  wire [17:0] B_ALU_dly;
  wire [29:0] A_ALU_dly;
  wire [2:0] CARRYINSEL_dly;
  wire [3:0] ALUMODE_dly;
  wire [44:0] U_DATA_dly;
  wire [44:0] V_DATA_dly;
  wire [47:0] C_DATA_dly;
  wire [47:0] PCIN_dly;
  wire [47:0] P_FDBK_dly;
  wire [8:0] OPMODE_dly;
`endif
...
`ifdef XIL_TIMING
  assign #(in_delay) A_ALU_dly = A_ALU;
  assign #(in_delay) B_ALU_dly = B_ALU;
  assign #(in_delay) CARRYCASCIN_dly = CARRYCASCIN;
  assign #(in_delay) CCOUT_dly = CCOUT;
  assign #(in_delay) C_DATA_dly = C_DATA;
  assign #(in_delay) MULTSIGNIN_dly = MULTSIGNIN;
  assign #(in_delay) PCIN_dly = PCIN;
  assign #(in_delay) P_FDBK_47_dly = P_FDBK_47;
  assign #(in_delay) P_FDBK_dly = P_FDBK;
  assign #(in_delay) U_DATA_dly = U_DATA;
  assign #(in_delay) V_DATA_dly = V_DATA;
`endif


`ifdef XIL_TIMING
  assign ALUMODE_in[0] = (ALUMODE[0] !== 1'bz) && (ALUMODE_dly[0] ^ IS_ALUMODE_INVERTED_BIN[0]); // rv 0
  assign ALUMODE_in[1] = (ALUMODE[1] !== 1'bz) && (ALUMODE_dly[1] ^ IS_ALUMODE_INVERTED_BIN[1]); // rv 0
  assign ALUMODE_in[2] = (ALUMODE[2] !== 1'bz) && (ALUMODE_dly[2] ^ IS_ALUMODE_INVERTED_BIN[2]); // rv 0
  assign ALUMODE_in[3] = (ALUMODE[3] !== 1'bz) && (ALUMODE_dly[3] ^ IS_ALUMODE_INVERTED_BIN[3]); // rv 0
  assign AMULT26_in = AMULT26_dly;
  assign A_ALU_in = A_ALU_dly;
  assign BMULT17_in = BMULT17_dly;
  assign B_ALU_in = B_ALU_dly;
  assign CARRYCASCIN_in = CARRYCASCIN_dly;
  assign CARRYINSEL_in[0] = (CARRYINSEL[0] !== 1'bz) && CARRYINSEL_dly[0]; // rv 0
  assign CARRYINSEL_in[1] = (CARRYINSEL[1] !== 1'bz) && CARRYINSEL_dly[1]; // rv 0
  assign CARRYINSEL_in[2] = (CARRYINSEL[2] !== 1'bz) && CARRYINSEL_dly[2]; // rv 0
  assign CARRYIN_in = (CARRYIN !== 1'bz) && (CARRYIN_dly ^ IS_CARRYIN_INVERTED_BIN); // rv 0
  assign CCOUT_in = CCOUT_dly;
  assign CEALUMODE_in = (CEALUMODE !== 1'bz) && CEALUMODE_dly; // rv 0
  assign CECARRYIN_in = (CECARRYIN !== 1'bz) && CECARRYIN_dly; // rv 0
  assign CECTRL_in = (CECTRL !== 1'bz) && CECTRL_dly; // rv 0
  assign CEM_in = (CEM !== 1'bz) && CEM_dly; // rv 0
  assign CLK_in = (CLK !== 1'bz) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign C_DATA_in = C_DATA_dly;
  assign MULTSIGNIN_in = MULTSIGNIN_dly;
  assign OPMODE_in[0] = (OPMODE[0] !== 1'bz) && (OPMODE_dly[0] ^ IS_OPMODE_INVERTED_BIN[0]); // rv 0
  assign OPMODE_in[1] = (OPMODE[1] !== 1'bz) && (OPMODE_dly[1] ^ IS_OPMODE_INVERTED_BIN[1]); // rv 0
  assign OPMODE_in[2] = (OPMODE[2] !== 1'bz) && (OPMODE_dly[2] ^ IS_OPMODE_INVERTED_BIN[2]); // rv 0
  assign OPMODE_in[3] = (OPMODE[3] !== 1'bz) && (OPMODE_dly[3] ^ IS_OPMODE_INVERTED_BIN[3]); // rv 0
  assign OPMODE_in[4] = (OPMODE[4] !== 1'bz) && (OPMODE_dly[4] ^ IS_OPMODE_INVERTED_BIN[4]); // rv 0
  assign OPMODE_in[5] = (OPMODE[5] !== 1'bz) && (OPMODE_dly[5] ^ IS_OPMODE_INVERTED_BIN[5]); // rv 0
  assign OPMODE_in[6] = (OPMODE[6] !== 1'bz) && (OPMODE_dly[6] ^ IS_OPMODE_INVERTED_BIN[6]); // rv 0
  assign OPMODE_in[7] = (OPMODE[7] !== 1'bz) && (OPMODE_dly[7] ^ IS_OPMODE_INVERTED_BIN[7]); // rv 0
  assign OPMODE_in[8] = (OPMODE[8] !== 1'bz) && (OPMODE_dly[8] ^ IS_OPMODE_INVERTED_BIN[8]); // rv 0
  assign PCIN_in = PCIN_dly;
  assign P_FDBK_47_in = P_FDBK_47_dly;
  assign P_FDBK_in = P_FDBK_dly;
  assign RSTALLCARRYIN_in = (RSTALLCARRYIN !== 1'bz) && (RSTALLCARRYIN_dly ^ IS_RSTALLCARRYIN_INVERTED_BIN); // rv 0
  assign RSTALUMODE_in = (RSTALUMODE !== 1'bz) && (RSTALUMODE_dly ^ IS_RSTALUMODE_INVERTED_BIN); // rv 0
  assign RSTCTRL_in = (RSTCTRL !== 1'bz) && (RSTCTRL_dly ^ IS_RSTCTRL_INVERTED_BIN); // rv 0
  assign U_DATA_in = (USE_SIMD_BIN == USE_SIMD_ONE48) ? U_DATA_dly : 45'h100000000000;
  assign V_DATA_in = (USE_SIMD_BIN == USE_SIMD_ONE48) ? V_DATA_dly : 45'h100000000000;
`else
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge CLK, negedge ALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALUMODE_dly);
    $setuphold (negedge CLK, negedge AMULT26, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, AMULT26_dly);
    $setuphold (negedge CLK, negedge BMULT17, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, BMULT17_dly);
    $setuphold (negedge CLK, negedge CARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CARRYIN_dly);
    $setuphold (negedge CLK, negedge CARRYINSEL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CARRYINSEL_dly);
    $setuphold (negedge CLK, negedge CEALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEALUMODE_dly);
    $setuphold (negedge CLK, negedge CECARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CECARRYIN_dly);
    $setuphold (negedge CLK, negedge CECTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CECTRL_dly);
    $setuphold (negedge CLK, negedge CEM, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEM_dly);
    $setuphold (negedge CLK, negedge OPMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, OPMODE_dly);
    $setuphold (negedge CLK, negedge RSTALLCARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTALLCARRYIN_dly);
    $setuphold (negedge CLK, negedge RSTALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTALUMODE_dly);
    $setuphold (negedge CLK, negedge RSTCTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTCTRL_dly);
    $setuphold (negedge CLK, posedge ALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ALUMODE_dly);
    $setuphold (negedge CLK, posedge AMULT26, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, AMULT26_dly);
    $setuphold (negedge CLK, posedge BMULT17, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, BMULT17_dly);
    $setuphold (negedge CLK, posedge CARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CARRYIN_dly);
    $setuphold (negedge CLK, posedge CARRYINSEL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CARRYINSEL_dly);
    $setuphold (negedge CLK, posedge CEALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEALUMODE_dly);
    $setuphold (negedge CLK, posedge CECARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CECARRYIN_dly);
    $setuphold (negedge CLK, posedge CECTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CECTRL_dly);
    $setuphold (negedge CLK, posedge CEM, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEM_dly);
    $setuphold (negedge CLK, posedge OPMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, OPMODE_dly);
    $setuphold (negedge CLK, posedge RSTALLCARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTALLCARRYIN_dly);
    $setuphold (negedge CLK, posedge RSTALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTALUMODE_dly);
    $setuphold (negedge CLK, posedge RSTCTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTCTRL_dly);
    $setuphold (posedge CLK, negedge ALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALUMODE_dly);
    $setuphold (posedge CLK, negedge AMULT26, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, AMULT26_dly);
    $setuphold (posedge CLK, negedge BMULT17, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, BMULT17_dly);
    $setuphold (posedge CLK, negedge CARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CARRYIN_dly);
    $setuphold (posedge CLK, negedge CARRYINSEL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CARRYINSEL_dly);
    $setuphold (posedge CLK, negedge CEALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEALUMODE_dly);
    $setuphold (posedge CLK, negedge CECARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CECARRYIN_dly);
    $setuphold (posedge CLK, negedge CECTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CECTRL_dly);
    $setuphold (posedge CLK, negedge CEM, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEM_dly);
    $setuphold (posedge CLK, negedge OPMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, OPMODE_dly);
    $setuphold (posedge CLK, negedge RSTALLCARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTALLCARRYIN_dly);
    $setuphold (posedge CLK, negedge RSTALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTALUMODE_dly);
    $setuphold (posedge CLK, negedge RSTCTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTCTRL_dly);
    $setuphold (posedge CLK, posedge ALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ALUMODE_dly);
    $setuphold (posedge CLK, posedge AMULT26, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, AMULT26_dly);
    $setuphold (posedge CLK, posedge BMULT17, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, BMULT17_dly);
    $setuphold (posedge CLK, posedge CARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CARRYIN_dly);
    $setuphold (posedge CLK, posedge CARRYINSEL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CARRYINSEL_dly);
    $setuphold (posedge CLK, posedge CEALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEALUMODE_dly);
    $setuphold (posedge CLK, posedge CECARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CECARRYIN_dly);
    $setuphold (posedge CLK, posedge CECTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CECTRL_dly);
    $setuphold (posedge CLK, posedge CEM, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEM_dly);
    $setuphold (posedge CLK, posedge OPMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, OPMODE_dly);
    $setuphold (posedge CLK, posedge RSTALLCARRYIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTALLCARRYIN_dly);
    $setuphold (posedge CLK, posedge RSTALUMODE, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTALUMODE_dly);
    $setuphold (posedge CLK, posedge RSTCTRL, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTCTRL_dly);
