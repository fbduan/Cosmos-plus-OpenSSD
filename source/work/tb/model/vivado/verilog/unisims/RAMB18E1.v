...
`endif //  `ifdef XIL_TIMING
    ...
    wire rstregb_tmp;
    wire [13:0] addrardaddr_tmp;
    wire [13:0] addrbwraddr_tmp;
    wire [15:0] diadi_tmp;
    wire [15:0] dibdi_tmp;
    wire [1:0] dipadip_tmp;
    wire [1:0] dipbdip_tmp;
    wire [1:0] wea_tmp;
    wire [3:0] webwe_tmp;
...
`endif //  `ifdef XIL_TIMING
   ...
   assign addrardaddr_in = addrardaddr_tmp ^ 14'b00000000000000;
   assign addrbwraddr_in = addrbwraddr_tmp ^ 14'b00000000000000;
   assign diadi_in = diadi_tmp ^ 16'h0000;
   assign dibdi_in = dibdi_tmp ^ 16'h0000;
   assign dipadip_in = dipadip_tmp ^ 2'b00;
   assign dipbdip_in = dipbdip_tmp ^ 2'b00;
   assign wea_in = wea_tmp ^ 2'b00;
   assign webwe_in = webwe_tmp ^ 4'h0;
