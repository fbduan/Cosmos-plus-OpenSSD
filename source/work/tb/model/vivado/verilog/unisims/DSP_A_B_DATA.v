...
`ifdef XIL_TIMING
  wire [17:0] B1_DATA_dly;
  wire [17:0] B2_DATA_dly;
  wire [17:0] BCOUT_dly;
  wire [17:0] B_ALU_dly;
  wire [26:0] A1_DATA_dly;
  wire [26:0] A2_DATA_dly;
  wire [29:0] ACOUT_dly;
  wire [29:0] A_ALU_dly;
...
`ifdef XIL_TIMING
  ...
  assign A_in[0] = (A[0] === 1'bz) || A_dly[0]; // rv 1
  assign A_in[10] = (A[10] === 1'bz) || A_dly[10]; // rv 1
  assign A_in[11] = (A[11] === 1'bz) || A_dly[11]; // rv 1
  assign A_in[12] = (A[12] === 1'bz) || A_dly[12]; // rv 1
  assign A_in[13] = (A[13] === 1'bz) || A_dly[13]; // rv 1
  assign A_in[14] = (A[14] === 1'bz) || A_dly[14]; // rv 1
  assign A_in[15] = (A[15] === 1'bz) || A_dly[15]; // rv 1
  assign A_in[16] = (A[16] === 1'bz) || A_dly[16]; // rv 1
  assign A_in[17] = (A[17] === 1'bz) || A_dly[17]; // rv 1
  assign A_in[18] = (A[18] === 1'bz) || A_dly[18]; // rv 1
  assign A_in[19] = (A[19] === 1'bz) || A_dly[19]; // rv 1
  assign A_in[1] = (A[1] === 1'bz) || A_dly[1]; // rv 1
  assign A_in[20] = (A[20] === 1'bz) || A_dly[20]; // rv 1
  assign A_in[21] = (A[21] === 1'bz) || A_dly[21]; // rv 1
  assign A_in[22] = (A[22] === 1'bz) || A_dly[22]; // rv 1
  assign A_in[23] = (A[23] === 1'bz) || A_dly[23]; // rv 1
  assign A_in[24] = (A[24] === 1'bz) || A_dly[24]; // rv 1
  assign A_in[25] = (A[25] === 1'bz) || A_dly[25]; // rv 1
  assign A_in[26] = (A[26] === 1'bz) || A_dly[26]; // rv 1
  assign A_in[27] = (A[27] === 1'bz) || A_dly[27]; // rv 1
  assign A_in[28] = (A[28] === 1'bz) || A_dly[28]; // rv 1
  assign A_in[29] = (A[29] === 1'bz) || A_dly[29]; // rv 1
  assign A_in[2] = (A[2] === 1'bz) || A_dly[2]; // rv 1
  assign A_in[3] = (A[3] === 1'bz) || A_dly[3]; // rv 1
  assign A_in[4] = (A[4] === 1'bz) || A_dly[4]; // rv 1
  assign A_in[5] = (A[5] === 1'bz) || A_dly[5]; // rv 1
  assign A_in[6] = (A[6] === 1'bz) || A_dly[6]; // rv 1
  assign A_in[7] = (A[7] === 1'bz) || A_dly[7]; // rv 1
  assign A_in[8] = (A[8] === 1'bz) || A_dly[8]; // rv 1
  assign A_in[9] = (A[9] === 1'bz) || A_dly[9]; // rv 1
  assign BCIN_in = BCIN_dly;
  assign B_in[0] = (B[0] === 1'bz) || B_dly[0]; // rv 1
  assign B_in[10] = (B[10] === 1'bz) || B_dly[10]; // rv 1
  assign B_in[11] = (B[11] === 1'bz) || B_dly[11]; // rv 1
  assign B_in[12] = (B[12] === 1'bz) || B_dly[12]; // rv 1
  assign B_in[13] = (B[13] === 1'bz) || B_dly[13]; // rv 1
  assign B_in[14] = (B[14] === 1'bz) || B_dly[14]; // rv 1
  assign B_in[15] = (B[15] === 1'bz) || B_dly[15]; // rv 1
  assign B_in[16] = (B[16] === 1'bz) || B_dly[16]; // rv 1
  assign B_in[17] = (B[17] === 1'bz) || B_dly[17]; // rv 1
  assign B_in[1] = (B[1] === 1'bz) || B_dly[1]; // rv 1
  assign B_in[2] = (B[2] === 1'bz) || B_dly[2]; // rv 1
  assign B_in[3] = (B[3] === 1'bz) || B_dly[3]; // rv 1
  assign B_in[4] = (B[4] === 1'bz) || B_dly[4]; // rv 1
  assign B_in[5] = (B[5] === 1'bz) || B_dly[5]; // rv 1
  assign B_in[6] = (B[6] === 1'bz) || B_dly[6]; // rv 1
  assign B_in[7] = (B[7] === 1'bz) || B_dly[7]; // rv 1
  assign B_in[8] = (B[8] === 1'bz) || B_dly[8]; // rv 1
  assign B_in[9] = (B[9] === 1'bz) || B_dly[9]; // rv 1
  assign CEA1_in = (CEA1 !== 1'bz) && CEA1_dly; // rv 0
  assign CEA2_in = (CEA2 !== 1'bz) && CEA2_dly; // rv 0
  assign CEB1_in = (CEB1 !== 1'bz) && CEB1_dly; // rv 0
  assign CEB2_in = (CEB2 !== 1'bz) && CEB2_dly; // rv 0
  assign CLK_areg1  = ((CLK !== 1'bz) && (AREG_BIN != AREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign CLK_areg2  = ((CLK !== 1'bz) && (AREG_BIN != AREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign CLK_breg1  = ((CLK !== 1'bz) && (BREG_BIN != BREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign CLK_breg2  = ((CLK !== 1'bz) && (BREG_BIN != BREG_0)) && (CLK_dly ^ IS_CLK_INVERTED_BIN); // rv 0
  assign RSTA_in = (RSTA !== 1'bz) && (RSTA_dly ^ IS_RSTA_INVERTED_BIN); // rv 0
  assign RSTB_in = (RSTB !== 1'bz) && (RSTB_dly ^ IS_RSTB_INVERTED_BIN); // rv 0
`else
  assign ACIN_in = ACIN;
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge CLK, negedge A, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, A_dly);
    $setuphold (negedge CLK, negedge ACIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ACIN_dly);
    $setuphold (negedge CLK, negedge B, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, B_dly);
    $setuphold (negedge CLK, negedge BCIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, BCIN_dly);
    $setuphold (negedge CLK, negedge CEA1, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEA1_dly);
    $setuphold (negedge CLK, negedge CEA2, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEA2_dly);
    $setuphold (negedge CLK, negedge CEB1, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEB1_dly);
    $setuphold (negedge CLK, negedge CEB2, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEB2_dly);
    $setuphold (negedge CLK, negedge RSTA, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTA_dly);
    $setuphold (negedge CLK, negedge RSTB, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTB_dly);
    $setuphold (negedge CLK, posedge A, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, A_dly);
    $setuphold (negedge CLK, posedge ACIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, ACIN_dly);
    $setuphold (negedge CLK, posedge B, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, B_dly);
    $setuphold (negedge CLK, posedge BCIN, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, BCIN_dly);
    $setuphold (negedge CLK, posedge CEA1, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEA1_dly);
    $setuphold (negedge CLK, posedge CEA2, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEA2_dly);
    $setuphold (negedge CLK, posedge CEB1, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEB1_dly);
    $setuphold (negedge CLK, posedge CEB2, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, CEB2_dly);
    $setuphold (negedge CLK, posedge RSTA, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTA_dly);
    $setuphold (negedge CLK, posedge RSTB, 0:0:0, 0:0:0, notifier,sh_clk_en_n,sh_clk_en_n, CLK_dly, RSTB_dly);
    $setuphold (posedge CLK, negedge A, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, A_dly);
    $setuphold (posedge CLK, negedge ACIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ACIN_dly);
    $setuphold (posedge CLK, negedge B, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, B_dly);
    $setuphold (posedge CLK, negedge BCIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, BCIN_dly);
    $setuphold (posedge CLK, negedge CEA1, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEA1_dly);
    $setuphold (posedge CLK, negedge CEA2, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEA2_dly);
    $setuphold (posedge CLK, negedge CEB1, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEB1_dly);
    $setuphold (posedge CLK, negedge CEB2, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEB2_dly);
    $setuphold (posedge CLK, negedge RSTA, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTA_dly);
    $setuphold (posedge CLK, negedge RSTB, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTB_dly);
    $setuphold (posedge CLK, posedge A, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, A_dly);
    $setuphold (posedge CLK, posedge ACIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, ACIN_dly);
    $setuphold (posedge CLK, posedge B, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, B_dly);
    $setuphold (posedge CLK, posedge BCIN, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, BCIN_dly);
    $setuphold (posedge CLK, posedge CEA1, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEA1_dly);
    $setuphold (posedge CLK, posedge CEA2, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEA2_dly);
    $setuphold (posedge CLK, posedge CEB1, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEB1_dly);
    $setuphold (posedge CLK, posedge CEB2, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, CEB2_dly);
    $setuphold (posedge CLK, posedge RSTA, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTA_dly);
    $setuphold (posedge CLK, posedge RSTB, 0:0:0, 0:0:0, notifier,sh_clk_en_p,sh_clk_en_p, CLK_dly, RSTB_dly);
