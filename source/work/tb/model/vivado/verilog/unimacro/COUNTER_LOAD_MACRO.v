// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/COUNTER_LOAD_MACRO.v,v 1.11 2010/12/01 23:01:10 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    initial begin
      if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6" || DEVICE == "SPARTAN6" || DEVICE == "7SERIES");
        ...
        begin
	  $display("Attribute Syntax Error : The attribute DEVICE on COUNTER_LOAD_MACRO instance %m is set to %s.  Allowed values of this attribute are VIRTEX5, VIRTEX6, SPARTAN6, 7SERIES.", DEVICE);
          $finish;
	end
