// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/COUNTER_TC_MACRO.v,v 1.10 2010/12/01 23:01:10 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    initial begin
      if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6" || DEVICE == "7SERIES");
        ...
        begin
	  $display("Attribute Syntax Error : The attribute DEVICE on COUNTER_TC_MACRO instance %m is set to %s.  Allowed values of this attribute are VIRTEX5, VIRTEX6, 7SERIES.", DEVICE);
          $finish;
	end
...
// Input ports
  ...
  assign OPMODE_INP = (RESET_UPON_TC == "TRUE") ? {1'b0, ~TC_INT, 3'b000, ~TC_INT, ~TC_INT} : 7'b0100011;
  assign Q = (RST == 1'b1 || ( CNTR_OUT_INT == (TC_VALUE+1) && RESET_UPON_TC == "TRUE") ) ? {(WIDTH_DATA-1){1'b0}} : CNTR_OUT_INT[WIDTH_DATA-1:0];
  assign TC_INT = (CNTR_OUT_INT == (TC_VALUE-1)  && RST == 1'b0) ? 1'b1 : 1'b0;
  assign TC = (CNTR_OUT_INT == TC_VALUE && RST == 1'b0) ? 1'b1 : 1'b0;
