// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/FIFO_DUALCLOCK_MACRO.v,v 1.11 2011/08/18 19:35:18 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//    08/22/11 - 621965 - Fix XST errors/warnings.
// End Revision
   ...
   parameter DEVICE = "VIRTEX5";
    ...
    initial begin
      if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6" || DEVICE == "7SERIES")
        ...
        begin
          $display("Attribute Syntax Error : The attribute DEVICE on FIFO_DUALCLOCK_MACRO instance %m is set to %s.  Legal values of this attribute are VIRTEX5, VIRTEX6, 7SERIES", DEVICE);
          $finish;
        end
    end // initial begin
