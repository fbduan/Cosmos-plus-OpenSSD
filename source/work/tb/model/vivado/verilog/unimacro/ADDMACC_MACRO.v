// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/ADDMACC_MACRO.v,v 1.11 2010/12/01 23:01:10 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    initial begin
      if ( DEVICE == "VIRTEX6" || DEVICE == "SPARTAN6" || DEVICE == "7SERIES");
      else
        begin
	  $display("Attribute Syntax Error : The attribute DEVICE on ADDMACC_MACRO instance %m is set to %s.  Allowed values of this attribute are VIRTEX6, SPARTAN6, 7SERIES.", DEVICE);
          $finish;
        end
      if(DEVICE == "VIRTEX6" || DEVICE == "7SERIES")
      begin 
