// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/EQ_COMPARE_MACRO.v,v 1.9 2010/12/01 23:01:10 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    initial begin
      ...
      if (DEVICE == "VIRTEX5" || DEVICE == "VIRTEX6" || DEVICE == "7SERIES");
        ...
        begin
	  $display("Attribute Syntax Error : The attribute DEVICE on EQUAL_MACRO instance %m is set to %s.  Allowed values of this attribute are VIRTEX5, VIRTEX6, 7SERIES.", DEVICE);
          $finish;
	end
