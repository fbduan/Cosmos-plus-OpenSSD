// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/unimacro/data/devlib/verilog/MACC_MACRO.v,v 1.16 2010/12/01 23:01:10 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//Parameter checks 
    ...
    begin
      $display("Attribute Syntax Error : The attribute DEVICE on MACC_MACRO instance %m is set to %s. Allowed values of this attribute are VIRTEX5, VIRTEX6, SPARTAN6, 7SERIES.", DEVICE);
      $finish;
    end
