...
architecture OSERDESE3_V of OSERDESE3 is
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'(OSERDESE3_V'INSTANCE_NAME));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-108] OSERDES_T_BYPASS attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-109] SIM_VERSION attribute is set to "));
  ...
  K2_OS_inst : if (SIM_VERSION = 2.0) generate
   ...
   V3T_OS_inst : if (SIM_VERSION = 1.0) generate
     OSERDESE3_INST : SIP_OSERDESE3
      port map (
        DATA_WIDTH           => DATA_WIDTH_BIN,
        INIT                 => INIT_BIN,
        ODDR_MODE            => ODDR_MODE_BIN,
