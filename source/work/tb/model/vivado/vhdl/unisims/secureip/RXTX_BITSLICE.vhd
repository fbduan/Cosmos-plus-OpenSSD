...
architecture RXTX_BITSLICE_V of RXTX_BITSLICE is
  component SIP_RXTX_BITSLICE
    ...
    port (
        ...
        RX_DATA_WIDTH        : in std_logic_vector(3 downto 0);
        ...
        RX_DELAY_VALUE       : in std_logic_vector(10 downto 0);
        ...
        TX_DATA_WIDTH        : in std_logic_vector(3 downto 0);
        ...
        TX_DELAY_VALUE       : in std_logic_vector(10 downto 0);
  ...
  END conv_string_to_slv;
    ...
    constant RX_DATA_WIDTH_BIN : std_logic_vector(3 downto 0) := std_logic_vector(to_unsigned(RX_DATA_WIDTH,4));
    constant RX_DC_ADJ_EN_BIN : std_logic_vector(0 downto 0) := "0";
    constant RX_DELAY_VALUE_BIN : std_logic_vector(10 downto 0) := std_logic_vector(to_unsigned(RX_DELAY_VALUE,11));
    ...
    constant TX_DATA_WIDTH_BIN : std_logic_vector(3 downto 0) := std_logic_vector(to_unsigned(TX_DATA_WIDTH,4));
    constant TX_DC_ADJ_EN_BIN : std_logic_vector(0 downto 0) := "0";
    constant TX_DELAY_VALUE_BIN : std_logic_vector(10 downto 0) := std_logic_vector(to_unsigned(TX_DELAY_VALUE,11));
  ...
  if((xil_attr_test) or
     ((RX_DELAY_TYPE /= "FIXED") and 
      (RX_DELAY_TYPE /= "VARIABLE") and 
      (RX_DELAY_TYPE /= "VAR_LOAD"))) then
    attr_err := true;
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    ...
    if ((RX_DELAY_VALUE < 0) or (RX_DELAY_VALUE > 1250)) then
      attr_err := true;
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
    ...
    if ((RX_REFCLK_FREQUENCY < 200.0) or (RX_REFCLK_FREQUENCY > 2400.0)) then
      attr_err := true;
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-124] SIM_VERSION attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-125] TBYTE_CTL attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-127] TX_DATA_WIDTH attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-129] TX_DELAY_FORMAT attribute is set to """));
  ...
  if((xil_attr_test) or
     ((TX_DELAY_TYPE /= "FIXED") and 
      (TX_DELAY_TYPE /= "VARIABLE") and 
      (TX_DELAY_TYPE /= "VAR_LOAD"))) then
    attr_err := true;
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-130] TX_DELAY_TYPE attribute is set to """));
    ...
    if ((TX_DELAY_VALUE < 0) or (TX_DELAY_VALUE > 1250)) then
      attr_err := true;
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-131] TX_DELAY_VALUE attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-133] TX_OUTPUT_PHASE_90 attribute is set to """));
    ...
    if ((TX_REFCLK_FREQUENCY < 200.0) or (TX_REFCLK_FREQUENCY > 2400.0)) then
      attr_err := true;
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-135] TX_REFCLK_FREQUENCY attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-137] TX_UPDATE_MODE attribute is set to """));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-128] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(RXTX_BITSLICE_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
  ...
  K2_RXTX_inst : if (SIM_VERSION = 2.0) generate
   ...
   V3T_RXTX_inst : if (SIM_VERSION = 1.0) generate
     RXTX_BITSLICE_INST : SIP_RXTX_BITSLICE
     port map (
        DDR_DIS_DQS          => DDR_DIS_DQS_BIN,
        ENABLE_PRE_EMPHASIS  => ENABLE_PRE_EMPHASIS_BIN,
        FIFO_SYNC_MODE       => FIFO_SYNC_MODE_BIN,
