...
architecture TX_BITSLICE_V of TX_BITSLICE is
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-117] SIM_VERSION attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-118] TBYTE_CTL attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-121] UPDATE_MODE attribute is set to """));
  ...
  K2_TX_inst : if (SIM_VERSION = 2.0) generate
  ...
  V3T_TX_inst : if (SIM_VERSION = 1.0) generate
    TX_BITSLICE_INST : SIP_TX_BITSLICE
      port map (
        DATA_WIDTH           => DATA_WIDTH_BIN,
        DC_ADJ_EN            => DC_ADJ_EN_BIN,
        DELAY_FORMAT         => DELAY_FORMAT_BIN,
