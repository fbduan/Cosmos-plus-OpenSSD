...
architecture TX_BITSLICE_TRI_V of TX_BITSLICE_TRI is
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'(TX_BITSLICE_TRI_V'INSTANCE_NAME));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-114] SIM_VERSION attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-115] UPDATE_MODE attribute is set to """));
  ...
  K2_TRI_inst : if (SIM_VERSION = 2.0) generate
   ...
   V3T_TRI_inst : if (SIM_VERSION = 1.0) generate 
    TX_BITSLICE_TRI_INST : SIP_TX_BITSLICE_TRI
     port map (
        DATA_WIDTH           => DATA_WIDTH_BIN,
        DC_ADJ_EN            => DC_ADJ_EN_BIN,
        DELAY_FORMAT         => DELAY_FORMAT_BIN,
