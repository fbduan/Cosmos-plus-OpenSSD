...
architecture BITSLICE_CONTROL_V of BITSLICE_CONTROL is
  component SIP_BITSLICE_CONTROL
  ...
  -- Parameter encodings and registers
    ...
    EN_VTC_in <= '1' when (EN_VTC = 'Z') else EN_VTC; -- rv 1
    ...
    RIU_CLK_in <= RIU_CLK;
    RIU_NIBBLE_SEL_in <= '0' when (RIU_NIBBLE_SEL = 'Z') else RIU_NIBBLE_SEL; -- rv 0
    ...
    TBYTE_IN_in(0) <= '0' when (TBYTE_IN(0) = 'Z') else TBYTE_IN(0); -- rv 0
    TBYTE_IN_in(1) <= '0' when (TBYTE_IN(1) = 'Z') else TBYTE_IN(1); -- rv 0
    TBYTE_IN_in(2) <= '0' when (TBYTE_IN(2) = 'Z') else TBYTE_IN(2); -- rv 0
    TBYTE_IN_in(3) <= '0' when (TBYTE_IN(3) = 'Z') else TBYTE_IN(3); -- rv 0
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("-102] CTRL_CLK attribute is set to """));
    Write ( Message, string'(CTRL_CLK));
    Write ( Message, string'(""". Legal values for this attribute are "));
    Write ( Message, string'("""EXTERNAL"" or "));
    Write ( Message, string'("""INTERNAL"". "));
    Write ( Message, string'("Instance "));
    Write ( Message, string'(BITSLICE_CONTROL_V'INSTANCE_NAME));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-104] DIV_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-109] EN_CLK_TO_EXT_NORTH attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-110] EN_CLK_TO_EXT_SOUTH attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-111] EN_DYN_ODLY_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-112] EN_OTHER_NCLK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-113] EN_OTHER_PCLK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-115] IDLY_VT_TRACK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-117] INV_RXCLK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-120] ODLY_VT_TRACK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-122] QDLY_VT_TRACK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-124] REFCLK_SRC attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-125] ROUNDING_FACTOR attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-126] RXGATE_EXTEND attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-127] RX_CLK_PHASE_N attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-128] RX_CLK_PHASE_P attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-129] RX_GATING attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-130] SELF_CALIBRATE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-131] SERIAL_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-132] SIM_SPEEDUP attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-133] SIM_VERSION attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-134] TX_GATING attribute is set to """));
  ...
  K2_BC_inst : if (SIM_VERSION = 2.0) generate
    ...
    V3T_BC_inst : if (SIM_VERSION = 1.0) generate
    BITSLICE_CONTROL_INST : SIP_BITSLICE_CONTROL
      port map (
        CONTROL_DLY_TEST_EN  => CONTROL_DLY_TEST_EN_BIN,
        CTRL_CLK             => CTRL_CLK_BIN,
        DC_ADJ_EN            => DC_ADJ_EN_BIN,
