...
architecture CMAC_V of CMAC is
  component SIP_CMAC
    ...
    port (
        ...
        RX_SOPOUT2           : out std_ulogic;
        RX_SOPOUT3           : out std_ulogic;
        SCAN_OUT_CMAC        : out std_logic_vector(181 downto 0);
        SCAN_OUT_DRPCTRL     : out std_logic_vector(12 downto 0);
        STAT_RX_ALIGNED      : out std_ulogic;
        STAT_RX_ALIGNED_ERR  : out std_ulogic;
        STAT_RX_BAD_CODE     : out std_logic_vector(6 downto 0);
        STAT_RX_BAD_FCS      : out std_logic_vector(3 downto 0);
        ...
        SCAN_IN_CMAC         : in std_logic_vector(181 downto 0);
        SCAN_IN_DRPCTRL      : in std_logic_vector(12 downto 0);
    ...
    constant MODULE_NAME : string := "CMAC";
  ...
  -- Parameter encodings and registers
    ...
    signal SCAN_OUT_CMAC_out : std_logic_vector(181 downto 0);
    signal SCAN_OUT_DRPCTRL_out : std_logic_vector(12 downto 0);
    signal STAT_RX_ALIGNED_ERR_out : std_ulogic;
    signal STAT_RX_ALIGNED_out : std_ulogic;
    signal STAT_RX_BAD_CODE_out : std_logic_vector(6 downto 0);
    signal STAT_RX_BAD_FCS_out : std_logic_vector(3 downto 0);
    ...
    signal STAT_RX_FRAGMENT_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_0_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_10_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_11_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_12_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_13_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_14_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_15_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_16_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_17_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_18_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_19_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_1_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_2_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_3_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_4_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_5_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_6_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_7_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_8_out : std_logic_vector(3 downto 0);
    signal STAT_RX_FRAMING_ERR_9_out : std_logic_vector(3 downto 0);
    ...
    signal STAT_RX_PACKET_SMALL_out : std_logic_vector(3 downto 0);
    ...
    signal STAT_RX_STOMPED_FCS_out : std_logic_vector(3 downto 0);
    ...
    signal STAT_RX_TOTAL_BYTES_out : std_logic_vector(7 downto 0);
    signal STAT_RX_TOTAL_GOOD_BYTES_out : std_logic_vector(13 downto 0);
    signal STAT_RX_TOTAL_GOOD_PACKETS_out : std_ulogic;
    signal STAT_RX_TOTAL_PACKETS_out : std_logic_vector(3 downto 0);
    signal STAT_RX_TRUNCATED_out : std_ulogic;
    signal STAT_RX_UNDERSIZE_out : std_logic_vector(3 downto 0);
    ...
    signal STAT_TX_TOTAL_BYTES_out : std_logic_vector(6 downto 0);
    ...
    signal SCAN_IN_CMAC_in : std_logic_vector(181 downto 0);
    signal SCAN_IN_DRPCTRL_in : std_logic_vector(12 downto 0);
    ...
    SCAN_IN_CMAC_in <= "11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111"; -- tie off
    SCAN_IN_DRPCTRL_in <= "1111111111111"; -- tie off
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-102] CTL_RX_CHECK_ACK attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-103] CTL_RX_CHECK_PREAMBLE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-104] CTL_RX_CHECK_SFD attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-105] CTL_RX_DELETE_FCS attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-110] CTL_RX_FORWARD_CONTROL attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-111] CTL_RX_IGNORE_FCS attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-123] CTL_RX_PROCESS_LFI attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-145] CTL_TEST_MODE_PIN_CHAR attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-150] CTL_TX_FCS_INS_ENABLE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-151] CTL_TX_IGNORE_FCS attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-154] CTL_TX_PTP_1STEP_ENABLE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-179] TEST_MODE_PIN_CHAR attribute is set to """));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-180] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(CMAC_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
