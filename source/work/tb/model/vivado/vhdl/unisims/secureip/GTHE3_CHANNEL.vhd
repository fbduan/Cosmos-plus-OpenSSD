...
--  /   /                        _no_description_
-- /___/   /\      Filename    : GTHE3_CHANNEL.vhd
-- \   \  /  \
--  \___\/\___\
--
-------------------------------------------------------------------------------
...
architecture GTHE3_CHANNEL_V of GTHE3_CHANNEL is
  component SIP_GTHE3_CHANNEL    
  generic (
        SIM_RECEIVER_DETECT_PASS : string := "TRUE";
        SIM_RESET_SPEEDUP : string := "TRUE";
        SIM_TX_EIDLE_DRIVE_LEVEL : bit := '0';
    ...
    port (
        ...
        AEN_QPI              : in std_logic_vector(0 downto 0);
        ...
        A_RXDFEAGCCTRL       : in std_logic_vector(1 downto 0);
        ...
        A_TXDIFFCTRL         : in std_logic_vector(3 downto 0);
        ...
        A_TXPOSTCURSORINV    : in std_logic_vector(0 downto 0);
        ...
        A_TXPRECURSORINV     : in std_logic_vector(0 downto 0);
        A_TXPROGDIVRESET     : in std_logic_vector(0 downto 0);
        A_TXQPIBIASEN        : in std_logic_vector(0 downto 0);
        ...
        RXOUT_DIV            : in std_logic_vector(4 downto 0);
        ...
        RXPI_CFG0            : in std_logic_vector(1 downto 0);
        RXPI_CFG1            : in std_logic_vector(1 downto 0);
        RXPI_CFG2            : in std_logic_vector(1 downto 0);
        RXPI_CFG3            : in std_logic_vector(1 downto 0);
        RXPI_CFG4            : in std_logic_vector(0 downto 0);
        RXPI_CFG5            : in std_logic_vector(0 downto 0);
        RXPI_CFG6            : in std_logic_vector(2 downto 0);
        ...
        RX_CTLE3_LPF         : in std_logic_vector(7 downto 0);
        ...
        RX_SUM_RES_CTRL      : in std_logic_vector(1 downto 0);
        ...
        RX_WIDEMODE_CDR      : in std_logic_vector(0 downto 0);
        ...
        TEMPERATUR_PAR       : in std_logic_vector(3 downto 0);
        ...
        TXDRVBIAS_N          : in std_logic_vector(3 downto 0);
        TXDRVBIAS_P          : in std_logic_vector(3 downto 0);
        ...
        TXOUT_DIV            : in std_logic_vector(4 downto 0);
        ...
        TX_QPI_STATUS_EN     : in std_logic_vector(0 downto 0);
        ...
        WB_MODE              : in std_logic_vector(1 downto 0);
        BUFGTCE              : out std_logic_vector(2 downto 0);
        BUFGTCEMASK          : out std_logic_vector(2 downto 0);
        BUFGTDIV             : out std_logic_vector(8 downto 0);
        BUFGTRESET           : out std_logic_vector(2 downto 0);
    ...
    constant MODULE_NAME : string := "GTHE3_CHANNEL";
  ...
  END conv_string_to_slv;
    ...
    constant AEN_QPI_BIN : std_logic_vector(0 downto 0) := "0";
    ...
    constant A_RXDFEAGCCTRL_BIN : std_logic_vector(1 downto 0) := "00";
    ...
    constant A_TXDIFFCTRL_BIN : std_logic_vector(3 downto 0) := "1100";
    ...
    constant A_TXQPIBIASEN_BIN : std_logic_vector(0 downto 0) := "0";
    ...
    constant RXOUT_DIV_BIN : std_logic_vector(4 downto 0) := std_logic_vector(to_unsigned(RXOUT_DIV,5));
    ...
    constant RXPI_CFG0_BIN : std_logic_vector(1 downto 0) := RXPI_CFG0;
    constant RXPI_CFG1_BIN : std_logic_vector(1 downto 0) := RXPI_CFG1;
    constant RXPI_CFG2_BIN : std_logic_vector(1 downto 0) := RXPI_CFG2;
    constant RXPI_CFG3_BIN : std_logic_vector(1 downto 0) := RXPI_CFG3;
    constant RXPI_CFG4_BIN : std_logic_vector(0 downto 0) := (0=>TO_X01(RXPI_CFG4));
    constant RXPI_CFG5_BIN : std_logic_vector(0 downto 0) := (0=>TO_X01(RXPI_CFG5));
    constant RXPI_CFG6_BIN : std_logic_vector(2 downto 0) := RXPI_CFG6;
    ...
    constant RX_CM_SEL_BIN : std_logic_vector(1 downto 0) := RX_CM_SEL;
    constant RX_CM_TRIM_BIN : std_logic_vector(3 downto 0) := RX_CM_TRIM;
    constant RX_CTLE3_LPF_BIN : std_logic_vector(7 downto 0) := RX_CTLE3_LPF;
    ...
    constant RX_DFELPM_CFG0_BIN : std_logic_vector(3 downto 0) := RX_DFELPM_CFG0;
    ...
    constant RX_DFE_AGC_CFG1_BIN : std_logic_vector(2 downto 0) := RX_DFE_AGC_CFG1;
    constant RX_DFE_KL_LPM_KH_CFG0_BIN : std_logic_vector(1 downto 0) := RX_DFE_KL_LPM_KH_CFG0;
    constant RX_DFE_KL_LPM_KH_CFG1_BIN : std_logic_vector(2 downto 0) := RX_DFE_KL_LPM_KH_CFG1;
    ...
    constant RX_SUM_RES_CTRL_BIN : std_logic_vector(1 downto 0) := RX_SUM_RES_CTRL;
    ...
    constant RX_WIDEMODE_CDR_BIN : std_logic_vector(0 downto 0) := (0=>TO_X01(RX_WIDEMODE_CDR));
    ...
    constant TEMPERATUR_PAR_BIN : std_logic_vector(3 downto 0) := TEMPERATUR_PAR;
    ...
    constant TXDRVBIAS_N_BIN : std_logic_vector(3 downto 0) := TXDRVBIAS_N;
    constant TXDRVBIAS_P_BIN : std_logic_vector(3 downto 0) := TXDRVBIAS_P;
    ...
    constant TXOUT_DIV_BIN : std_logic_vector(4 downto 0) := std_logic_vector(to_unsigned(TXOUT_DIV,5));
    ...
    constant TX_QPI_STATUS_EN_BIN : std_logic_vector(0 downto 0) := (0=>TO_X01(TX_QPI_STATUS_EN));
    constant TX_RXDETECT_CFG_BIN : std_logic_vector(13 downto 0) := TX_RXDETECT_CFG;
    constant TX_RXDETECT_REF_BIN : std_logic_vector(2 downto 0) := TX_RXDETECT_REF;
    ...
    constant WB_MODE_BIN : std_logic_vector(1 downto 0) := WB_MODE;
  ...
  -- Parameter encodings and registers
    ...
    signal PCSRSVDOUT_out : std_logic_vector(11 downto 0);
    ...
    signal GTHRXN_in : std_ulogic;
    signal GTHRXP_in : std_ulogic;
    ...
    signal RXDFEAGCCTRL_in : std_logic_vector(1 downto 0);
    ...
    signal TXPOSTCURSORINV_in : std_ulogic;
    ...
    signal TXPRECURSORINV_in : std_ulogic;
    signal TXPRECURSOR_in : std_logic_vector(4 downto 0);
    signal TXPROGDIVRESET_in : std_ulogic;
    signal TXQPIBIASEN_in : std_ulogic;
    signal TXQPISTRONGPDOWN_in : std_ulogic;
    signal TXQPIWEAKPUP_in : std_ulogic;
    ...
    GTHTXN <= GTHTXN_out after OUT_DELAY;
    GTHTXP <= GTHTXP_out after OUT_DELAY;
    ...
    RXQPISENN <= RXQPISENN_out after OUT_DELAY;
    RXQPISENP <= RXQPISENP_out after OUT_DELAY;
    ...
    TXQPISENN <= TXQPISENN_out after OUT_DELAY;
    TXQPISENP <= TXQPISENP_out after OUT_DELAY;
    ...
    RXDFEAGCCTRL_in(0) <= '0' when (RXDFEAGCCTRL(0) = 'Z') else RXDFEAGCCTRL(0); -- rv 0
    RXDFEAGCCTRL_in(1) <= '0' when (RXDFEAGCCTRL(1) = 'Z') else RXDFEAGCCTRL(1); -- rv 0
    ...
    RXQPIEN_in <= '0' when (RXQPIEN = 'Z') else RXQPIEN; -- rv 0
    ...
    TXPOSTCURSORINV_in <= '0' when (TXPOSTCURSORINV = 'Z') else TXPOSTCURSORINV; -- rv 0
    ...
    TXPRECURSORINV_in <= '0' when (TXPRECURSORINV = 'Z') else TXPRECURSORINV; -- rv 0
    ...
    TXQPIBIASEN_in <= '0' when (TXQPIBIASEN = 'Z') else TXQPIBIASEN; -- rv 0
    TXQPISTRONGPDOWN_in <= '0' when (TXQPISTRONGPDOWN = 'Z') else TXQPISTRONGPDOWN; -- rv 0
    TXQPIWEAKPUP_in <= '0' when (TXQPIWEAKPUP = 'Z') else TXQPIWEAKPUP; -- rv 0
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("-128] ALIGN_COMMA_DOUBLE attribute is set to """));
    Write ( Message, string'(ALIGN_COMMA_DOUBLE));
    Write ( Message, string'(""". Legal values for this attribute are "));
    Write ( Message, string'("""FALSE"" or "));
    Write ( Message, string'("""TRUE"". "));
    Write ( Message, string'("Instance "));
    Write ( Message, string'(GTHE3_CHANNEL_V'INSTANCE_NAME));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-130] ALIGN_COMMA_WORD attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-131] ALIGN_MCOMMA_DET attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-133] ALIGN_PCOMMA_DET attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-258] CBCC_DATA_SOURCE_SEL attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-260] CHAN_BOND_KEEP_ALIGN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-261] CHAN_BOND_MAX_SKEW attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-272] CHAN_BOND_SEQ_2_USE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-273] CHAN_BOND_SEQ_LEN attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-274] CLK_CORRECT_USE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-275] CLK_COR_KEEP_IDLE attribute is set to """));
    ...
    if ((CLK_COR_MAX_LAT < 3) or (CLK_COR_MAX_LAT > 60)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-276] CLK_COR_MAX_LAT attribute is set to "));
    ...
    if ((CLK_COR_MIN_LAT < 3) or (CLK_COR_MIN_LAT > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-277] CLK_COR_MIN_LAT attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-278] CLK_COR_PRECEDENCE attribute is set to """));
    ...
    if ((CLK_COR_REPEAT_WAIT < 0) or (CLK_COR_REPEAT_WAIT > 31)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-279] CLK_COR_REPEAT_WAIT attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-290] CLK_COR_SEQ_2_USE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-291] CLK_COR_SEQ_LEN attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-296] CPLL_FBDIV attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-297] CPLL_FBDIV_45 attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-301] CPLL_REFCLK_DIV attribute is set to "));
    ...
    if ((DDI_REALIGN_WAIT < 0) or (DDI_REALIGN_WAIT > 31)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-303] DDI_REALIGN_WAIT attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-304] DEC_MCOMMA_DETECT attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-305] DEC_PCOMMA_DETECT attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-306] DEC_VALID_COMMA_ONLY attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-313] ES_ERRDET_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-314] ES_EYE_SCAN_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-337] FTS_LANE_DESKEW_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-346] PCI3_AUTO_REALIGN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-360] PCS_PCIE_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-373] RXBUF_ADDR_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-376] RXBUF_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-377] RXBUF_RESET_ON_CB_CHANGE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-378] RXBUF_RESET_ON_COMMAALIGN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-379] RXBUF_RESET_ON_EIDLE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-380] RXBUF_RESET_ON_RATE_CHANGE attribute is set to """));
    ...
    if ((RXBUF_THRESH_OVFLW < 0) or (RXBUF_THRESH_OVFLW > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-381] RXBUF_THRESH_OVFLW attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-382] RXBUF_THRESH_OVRD attribute is set to """));
    ...
    if ((RXBUF_THRESH_UNDFLW < 0) or (RXBUF_THRESH_UNDFLW > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-383] RXBUF_THRESH_UNDFLW attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-452] RXELECIDLE_CFG attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-453] RXGBOX_FIFO_INIT_RD_ADDR attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-454] RXGEARBOX_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-463] RXOOB_CLK_CFG attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-465] RXOUT_DIV attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-482] RXPMACLK_SEL attribute is set to """));
    ...
    if ((RXPRBS_LINKACQ_CNT < 15) or (RXPRBS_LINKACQ_CNT > 255)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-485] RXPRBS_LINKACQ_CNT attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-486] RXSLIDE_AUTO_WAIT attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-487] RXSLIDE_MODE attribute is set to """));
    ...
    if ((RX_CLK25_DIV < 1) or (RX_CLK25_DIV > 32)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-495] RX_CLK25_DIV attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-503] RX_DATA_WIDTH attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-505] RX_DEFER_RESET_BUF_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-516] RX_DISPERR_SEQ_MATCH attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-524] RX_INT_DATAWIDTH attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-526] RX_PROGDIV_CFG attribute is set to "));
    ...
    if ((RX_SIG_VALID_DLY < 1) or (RX_SIG_VALID_DLY > 32)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-528] RX_SIG_VALID_DLY attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-537] RX_XCLK_SEL attribute is set to """));
    ...
    if ((SAS_MAX_COM < 1) or (SAS_MAX_COM > 127)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-538] SAS_MAX_COM attribute is set to "));
    ...
    if ((SAS_MIN_COM < 1) or (SAS_MIN_COM > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-539] SAS_MIN_COM attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-542] SATA_CPLL_CFG attribute is set to """));
    ...
    if ((SATA_MAX_BURST < 1) or (SATA_MAX_BURST > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-544] SATA_MAX_BURST attribute is set to "));
    ...
    if ((SATA_MAX_INIT < 1) or (SATA_MAX_INIT > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-545] SATA_MAX_INIT attribute is set to "));
    ...
    if ((SATA_MAX_WAKE < 1) or (SATA_MAX_WAKE > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-546] SATA_MAX_WAKE attribute is set to "));
    ...
    if ((SATA_MIN_BURST < 1) or (SATA_MIN_BURST > 61)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-547] SATA_MIN_BURST attribute is set to "));
    ...
    if ((SATA_MIN_INIT < 1) or (SATA_MIN_INIT > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-548] SATA_MIN_INIT attribute is set to "));
    ...
    if ((SATA_MIN_WAKE < 1) or (SATA_MIN_WAKE > 63)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-549] SATA_MIN_WAKE attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-550] SHOW_REALIGN_COMMA attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-551] SIM_RECEIVER_DETECT_PASS attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-552] SIM_RESET_SPEEDUP attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-554] SIM_VERSION attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-562] TXBUF_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-563] TXBUF_RESET_ON_RATE_CHANGE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-568] TXFIFO_ADDR_CFG attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-569] TXGBOX_FIFO_INIT_RD_ADDR attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-570] TXGEARBOX_EN attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-572] TXOUT_DIV attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-587] TXPI_PPMCLK_SEL attribute is set to """));
    ...
    if ((TX_CLK25_DIV < 1) or (TX_CLK25_DIV > 32)) then
      ...
      Write ( Message, string'("Error : [Unisim "));
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-595] TX_CLK25_DIV attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-597] TX_DATA_WIDTH attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-603] TX_DRIVE_MODE attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-609] TX_INT_DATAWIDTH attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-610] TX_LOOPBACK_DRIVE_HIZ attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-625] TX_PROGCLK_SEL attribute is set to """));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-626] TX_PROGDIV_CFG attribute is set to "));
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, string'("Error : [Unisim "));
    Write ( Message, string'(MODULE_NAME));
    Write ( Message, string'("-636] TX_XCLK_SEL attribute is set to """));
    ...
    if  (attr_err) then
      ...
      Write ( Message, string'(MODULE_NAME));
      Write ( Message, string'("-488] Attribute Error(s) encountered. "));
      Write ( Message, string'("Instance "));
      Write ( Message, string'(GTHE3_CHANNEL_V'INSTANCE_NAME));
      assert FALSE
      report Message.all
    ...
    GTHE3_CHANNEL_INST : SIP_GTHE3_CHANNEL
      generic map (
      ...
      port map (
        ...
        A_RXDFEAGCCTRL       => A_RXDFEAGCCTRL_BIN,
        ...
        RXPI_CFG2            => RXPI_CFG2_BIN,
        RXPI_CFG3            => RXPI_CFG3_BIN,
        RXPI_CFG4            => RXPI_CFG4_BIN,
        RXPI_CFG5            => RXPI_CFG5_BIN,
        RXPI_CFG6            => RXPI_CFG6_BIN,
        ...
        TEMPERATUR_PAR       => TEMPERATUR_PAR_BIN,
        ...
        TXDRVBIAS_N          => TXDRVBIAS_N_BIN,
        TXDRVBIAS_P          => TXDRVBIAS_P_BIN,
        ...
        TX_QPI_STATUS_EN     => TX_QPI_STATUS_EN_BIN,
