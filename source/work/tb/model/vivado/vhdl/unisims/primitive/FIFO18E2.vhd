...
--    CASNXTRDEN_in <= CASNXTRDEN_delay;
  ...
  mem_rd_en_a  <= (RDEN_in or 
                  ((fill_lat or fill_reg ) and not SLEEP_int))
    ...
    case READ_WIDTH is
      when  4   =>
        if (PROG_EMPTY_THRESH >= 1) and (PROG_EMPTY_THRESH <= mem_depth_f) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-125]: PROG_EMPTY_THRESH is not in range 1 .. "));
      ...
      when  9   => 
        if (PROG_EMPTY_THRESH >= 1) and (PROG_EMPTY_THRESH <= mem_depth_f/2) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-126]: PROG_EMPTY_THRESH is not in range 1 .. "));
      ...
      when  18   =>
        if (PROG_EMPTY_THRESH >= 1) and (PROG_EMPTY_THRESH <= mem_depth_f/4) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-127]: PROG_EMPTY_THRESH is not in range 1 .. "));
      ...
      when  36   =>
        if (PROG_EMPTY_THRESH >= 1) and (PROG_EMPTY_THRESH <= mem_depth_f/8) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-128]: PROG_EMPTY_THRESH is not in range 1 .. "));
    ...
    case WRITE_WIDTH is
      when  4   =>
        if (PROG_FULL_THRESH >= 1) and (PROG_FULL_THRESH <= mem_depth_f) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-131]: PROG_FULL_THRESH is not in range 1 .. "));
          Write ( Message, mem_depth_f);
          Write ( Message, string'("."));
          assert FALSE report Message.all severity error;
          DEALLOCATE(Message);
      ...
      when  9   => 
        if (PROG_FULL_THRESH >= 1) and (PROG_FULL_THRESH <= mem_depth_f/2) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-132]: PROG_FULL_THRESH is not in range 1 .. "));
          Write ( Message, mem_depth_f/2);
          Write ( Message, string'("."));
          assert FALSE report Message.all severity error;
          DEALLOCATE(Message);
      ...
      when  18   =>
        if (PROG_FULL_THRESH >= 1) and (PROG_FULL_THRESH <= mem_depth_f/4) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-133]: PROG_FULL_THRESH is not in range 1 .. "));
          Write ( Message, mem_depth_f/4);
          Write ( Message, string'("."));
          assert FALSE report Message.all severity error;
          DEALLOCATE(Message);
      ...
      when  36   =>
        if (PROG_FULL_THRESH >= 1) and (PROG_FULL_THRESH <= mem_depth_f/8) then 
          ...
          Write ( Message, string'("Error [Unisim FIFO18E2-134]: PROG_FULL_THRESH is not in range 1 .. "));
          Write ( Message, mem_depth_f/8);
          Write ( Message, string'("."));
          assert FALSE report Message.all severity error;
          DEALLOCATE(Message);
