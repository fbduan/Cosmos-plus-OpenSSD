...
mif_tab.field_names = ['Index', 'uPChSelect', 'uPAddrSrcRegSel', 'uPOpcode', 'uPSourceID', 'uPTargetID', 'uPLength', 'uPFunc']
with open(mif_file, "r") as fp:
    for l in fp:
        ...
        mif_tab.add_row(["%03x"%(len(mif)), "%01x-%s"%(mif[-1]['chsel'], uPChSelect[mif[-1]['chsel']]), "%01x-%s"%(mif[-1]['regsel'], uPAddrSrcRegSel[mif[-1]['regsel']]), "%02x"%mif[-1]['opcode'], "%02x"%mif[-1]['srcid'], "%02x"%mif[-1]['tgtid'], "%04x"%mif[-1]['len'], "%01x-%s"%(mif[-1]['func'], uPFunc[mif[-1]['func']])])
